...
import { findUserList, getFacebookFriends, sendFriendRequest, getFriendsRequestList, acceptFriendRequest } from '../../redux/api/auth'
...
const FacebookFriends = (props) => {
  ...
  useEffect(() => {
    //props.dispatch(getFacebookFriends())
  },[])
  ...
  return(
    <Container style={styles.mainContainer}>
      <Header backEnd blackBackBtn nextScreen="Footer" heading="Facebook Friends" navigation={props.navigation} centerHeading/>
      <View style={styles.formBox}>
        <TextInput 
          placeholder={convertText("profile.searchFBTravelz", lang)}
        ...
        <View style={styles.body}>          
          <TouchableOpacity style={styles.profileCon}>
            <View style={styles.picCon}>
              <Image source={require('../../assets/images/user1.jpg')} style={styles.imgStyle} />
            </View>
            <View style={styles.profileTextCon}>
              <Text style={styles.nameText}>User</Text>
            </View>
            <Ripple style={[styles.addBtn, styles.reqSentBtn]} >
          ...
          <TouchableOpacity style={styles.profileCon}>
            ...
            <Ripple style={[styles.addBtn, styles.disableBtn, styles.reqSentBtn]} >
              <Text style={{color: '#fff'}}>Request Sent</Text>
            </Ripple>
          </TouchableOpacity>
          <TouchableOpacity style={styles.profileCon}>
            <View style={styles.picCon}>
          ...
          <TouchableOpacity style={styles.profileCon}>
            ...
            {/* <Ripple style={[styles.addBtn, styles.reqSentBtn, {backgroundColor: 'green'}]} >
